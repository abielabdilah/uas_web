...
if ($result->num_rows > 0) {
 echo "<table border='1'>";
 echo "<tr><th>ID Peminjaman</th><th>ID Buku</th><th>ID Anggota</th><th>Tanggal Peminjaman</th><th>Tanggal Kembali</th><th>Status</th></tr>";
 ...
 echo "<td><a href='update_peminjaman.php?id=".$row["peminjaman_id"]."'></a></td>";
 echo "</tr>";
 }
 echo "</table>";
} else {
